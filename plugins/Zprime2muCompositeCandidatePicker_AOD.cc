...
class Zprime2muCompositeCandidatePicker_AOD : public edm::EDProducer {
public:
  explicit Zprime2muCompositeCandidatePicker_AOD(const edm::ParameterSet&);
...
Zprime2muCompositeCandidatePicker_AOD::Zprime2muCompositeCandidatePicker_AOD(const edm::ParameterSet& cfg)
...
void Zprime2muCompositeCandidatePicker_AOD::remove_overlap(pat::CompositeCandidateCollection& cands) const {
...
std::vector<reco::TransientTrack> Zprime2muCompositeCandidatePicker_AOD::get_transient_tracks(const pat::CompositeCandidate& dil) const {
...
std::pair<bool, float> Zprime2muCompositeCandidatePicker_AOD::back_to_back_cos_angle(const pat::CompositeCandidate& dil) const {
...
std::pair<bool, CachingVertex<5> > Zprime2muCompositeCandidatePicker_AOD::vertex_constrained_fit(const pat::CompositeCandidate& dil) const {
...
void Zprime2muCompositeCandidatePicker_AOD::embed_vertex_constrained_fit(pat::CompositeCandidate& dil, const CachingVertex<5>& vtx) const {
  if (!vtx.isValid()) {
...
std::pair<bool, float> Zprime2muCompositeCandidatePicker_AOD::dpt_over_pt(const pat::CompositeCandidate& dil) const {
...
void Zprime2muCompositeCandidatePicker_AOD::produce(edm::Event& event, const edm::EventSetup& setup) {
...
DEFINE_FWK_MODULE(Zprime2muCompositeCandidatePicker_AOD);
